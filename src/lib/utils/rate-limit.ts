...
// Cache rate limiters by config key
...
/**
 * Check rate limit for customer-facing endpoints (5 req/min default)
 */
...
/**
 * Configurable rate limit check for admin and custom endpoints
 */
